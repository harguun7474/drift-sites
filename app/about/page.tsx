        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              {
                title: "Excellence",
                description: "We are committed to delivering the highest quality services that exceed client expectations in every aspect of our work.",
              ...
              {
                title: "Innovation",
                description: "We continuously improve our methods, equipment, and techniques to deliver cutting-edge solutions that enhance efficiency and results.",
          ...
          >
            {[
              {
                title: "Safety",
                description: "We prioritize the safety of our team, clients, and properties in every project we undertake, following rigorous safety protocols at all times.",
                icon: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
              },
              {
                title: "Environmental Responsibility",
                description: "We embrace sustainable practices and eco-friendly solutions that minimize our environmental impact while creating beautiful, healthy spaces.",
