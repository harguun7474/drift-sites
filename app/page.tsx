        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 animate-on-scroll">
              ...
              <h3 className="text-xl font-bold mb-4 text-center">Customer Satisfaction</h3>
              <p className="text-gray-600 text-center">We go above and beyond to ensure every client is delighted with our work, delivering results that exceed expectations every time.</p>
            </div>
          </div>
        </div>
      </section>
