  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-on-scroll">
            <h2 className="section-title inline-block">What Our Clients Say</h2>
            <p className="text-gray-600 max-w-3xl mx-auto mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 animate-on-scroll">
              ...
              <p className="text-gray-600 italic">"Specialty Lawns transformed our backyard into the perfect space for entertaining. Their attention to detail and professionalism exceeded our expectations!"</p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 animate-on-scroll">
              ...
              <p className="text-gray-600 italic">"Moving my entire house seemed overwhelming, but the team at Specialty Lawns made it seamless. They handled everything with care and expertise."</p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 animate-on-scroll">
              ...
              <p className="text-gray-600 italic">"I've been using their regular lawn maintenance service for over a year now, and my yard has never looked better. Reliable, professional, and worth every penny!"</p>
            </div>
          </div>
        </div>
      </section>
